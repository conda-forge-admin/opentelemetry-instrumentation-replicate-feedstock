...
pixi add opentelemetry-instrumentation-replicate
# for installing globally
pixi global install opentelemetry-instrumentation-replicate
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-replicate` available on your platform:
...
```
pixi search opentelemetry-instrumentation-replicate --channel conda-forge
```
